      ...
      <div className="flex flex-col gap-3">
        ...
        <input
          ...
          className={`border border-[#ccc] w-[300px] p-[10px] focus:border-[#807bff] rounded-lg ${
            errors?.email ? "border-red-500 bg-red-200" : "border-gary-300"
          }`}
          type={"email"}
          placeholder={"이메일"}
        />
        ...
        <input
          {...register("password")}
          className={`border border-[#ccc] w-[300px] p-[10px] focus:border-[#807bff] rounded-lg ${
            errors?.password ? "border-red-500 bg-red-200" : "border-gary-300"
          }`}
          type={"password"}
          placeholder={"비밀번호"}
        />
        ...
        <input
          {...register("name")}
          className={`border border-[#ccc] w-[300px] p-[10px] focus:border-[#807bff] rounded-lg ${
            errors?.name ? "border-red-500 bg-red-200" : "border-gary-300"
          }`}
          type={"name"}
          placeholder={"이름"}
        />
